...
create table ride_details(Customer_id int,Driver_id int,Ride_date_time Datetime,amount decimal(10,2),payment_method varchar(25),foreign key(Driver_id) references Drivers(Driver_id),foreign key(Customer_id) references Customers(Customer_id))
...
create table order_details(Customer_id int,theatre_name varchar(25),pincode int,movie_name varchar(25),director_name varchar(25),order_date_time Datetime,show_date_time datetime,amount decimal(10,2),payment_method varchar(25),
...
create table products(product_id int primary key,product_name varchar(25),category varchar(25),price decimal(10,2))
...
create table orderdetails(order_id int,order_date date,ship_date date,estimated_delivery date,quantity int,amount decimal(10,2),payment_method varchar(20),foreign key(order_id) references orders(order_id))
